...
parser.add_argument("--dataset", type=str, default="rose11", choices=["rose", "FAZ500","rose1","rose11","zeiss", "cria", "drive", "origa", "refuge", "origa2", "mix", "iostar", "rimone", "rimone1"], help="dataset")  # choices可扩展
parser.add_argument("--model", type=str, default="unet", choices=["unet","FAZ500net","VES500net", "VESpial500net","cenet", "resunet", "csnet", "srfunet", "r2unet"], help="model")  # choices可扩展
parser.add_argument("--loss", type=str, default="mse", choices=["mse", "l1", "smoothl1", "bce", "focal", "dice", "smooth", "dice2"], help="loss")  # choices可扩展
parser.add_argument("--loss2", type=str, default="mse", choices=["mse", "l1", "smoothl1", "bce", "focal", "dice", "smooth", "dice2"], help="loss")  # choices可扩展
...
# first stage
parser.add_argument("--first_epochs", type=int, default=400, help="train epochs of first stage")
