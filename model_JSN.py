...
from utils_JSN import FeatureSelectionModule, FeatureAlignModule, MultiscaleSoftFusion
...
class base(nn.Module):
    ...
    def forward(self, x):
        ...
        rv_d9 = self.out(rv_d9)
        faz_d9 = self.out(faz_d9)
        rv_d9 = torch.sigmoid(rv_d9)
        faz_d9 = torch.sigmoid(faz_d9)
