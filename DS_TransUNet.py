...
#from utils_DS.checkpoint import load_checkpoint
#from mmseg.utils import get_root_logger

from utils_DS.module import Attention, PreNorm, FeedForward, CrossAttention
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.):
        ...
        self.fc1 = nn.Linear(in_features, hidden_features).cpu()
        self.act = act_layer()
        self.fc2 = nn.Linear(hidden_features, out_features).cpu()   ##################################
