...
def calc_sen(pred_arr, gt_arr, kernel_size=(1,1), mask_arr=None):
    # pred_vec, gt_vec = extract_mask(pred_arr, gt_arr, mask_arr=mask_arr)
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    sen = TP / (FN + TP + 1e-12)
...
def calc_fdr(pred_arr, gt_arr, kernel_size=(1,1), mask_arr=None):
    # pred_vec, gt_vec = extract_mask(pred_arr, gt_arr, mask_arr=mask_arr)
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    fdr = FP / (FP + TP + 1e-12)
...
def calc_spe(pred_arr, gt_arr, kernel_size=(1,1), mask_arr=None):
    # pred_vec, gt_vec = extract_mask(pred_arr, gt_arr, mask_arr=mask_arr)
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
    spe = TN / (FP + TN + 1e-12)
...
def calc_iou(pred_arr, gt_arr, kernel_size=(1,1), mask_arr=None):
    # pred_vec, gt_vec = extract_mask(pred_arr, gt_arr, mask_arr=mask_arr)
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
...
def calc_dice(pred_arr, gt_arr, kernel_size=(1,1), mask_arr=None):
    # pred_vec, gt_vec = extract_mask(pred_arr, gt_arr, mask_arr=mask_arr)
    FP, FN, TP, TN = numeric_score(pred_arr, gt_arr, kernel_size)
